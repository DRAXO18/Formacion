    ...
    <div class="page-content">
        <div class="container-fluid">
                ...
                <div class="col-sm-6">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: fvoid(0);">Dashboard</a></li>
            ...
            <div class="row">
                    ...
                    <div class="card mini-stat bg-primary">
                        <div class="card-body mini-stat-img">
                            <div class="mini-stat-icon">
                                <i class="mdi mdi-package-variant float-end"></i>
                            </div>
                            <div class="text-white">
                                <h6 class="text-uppercase mb-3 font-size-16 text-white">Productos</h6>
                                <h2 class="mb-4 text-white">1,587</h2>
                                <span class="badge bg-info"> +11% </span> <span class="ms-2">From
                                    previous
                                    period</span>
                            </div>
                        </div>
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="card mini-stat bg-primary">
                        <div class="card-body mini-stat-img">
                            <div class="mini-stat-icon">
                                <i class="mdi mdi-tag float-end"></i>
                            </div>
                            <div class="text-white">
                                <h6 class="text-uppercase mb-3 font-size-16 text-white">Marcas</h6>
                                <h2 class="mb-4 text-white">$46,782</h2>
                                <span class="badge bg-danger"> -29% </span> <span class="ms-2">From
                                    previous
                                    period</span>
                            </div>
                        </div>
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="card mini-stat bg-primary">
                        <div class="card-body mini-stat-img">
                            <div class="mini-stat-icon">
                                <i class="mdi mdi-cart-outline float-end"></i>
                            </div>
                            <div class="text-white">
                                <h6 class="text-uppercase mb-3 font-size-16 text-white">Ventas</h6>
                                <h2 class="mb-4 text-white">1890</h2>
                                <span class="badge bg-info"> +89% </span> <span class="ms-2">From
                                    previous
                                    period</span>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <!-- Tarjeta y gráfico para el Producto Más Vendido -->
                <div class="col-xl-4">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title mb-4">Producto Más Vendido</h4>
                            <div class="row text-center mt-4">
                                <div class="col-12">
                                    @if (isset($data['productoMasVendido']))
                                        <h5 class="font-size-20">{{ $data['productoMasVendido']->nombre }}
                                        </h5>
                                        <p class="text-muted">Cantidad vendida:
                                            {{ $data['productoMasVendido']->cantidad_vendida }}</p>
                                    @else
                                        <p class="text-muted">No hay datos disponibles</p>
                                    @endif
                                </div>
                            </div>
                            <!-- Puedes integrar aquí el gráfico correspondiente usando Chart.js, Morris.js u otra librería -->
                        </div>
                    </div>
                </div>
                            ...
                            <div class="inbox-wid">
                                ...
                                <a href="#" class="text-dark">
                                    <div class="inbox-item">
                                        ...
                                        <p class="inbox-item-text text-muted mb-0">This theme is awesome!
                                        </p>
                ...
                <div class="col-xl-4">
                    <div class="card widget-user">
                        <div class="widget-user-desc p-4 text-center bg-primary position-relative">
                            ...
                            <p class="text-white mb-0">The European languages are members of the same
                                family.
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/images/users/user-2.jpg" alt="user-image"
                                                    class="avatar-xs rounded-circle me-2" /> Herbert C.
                                                Patton
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/images/users/user-3.jpg" alt="user-image"
                                                    class="avatar-xs rounded-circle me-2" /> Mathias N.
                                                Klausen
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/images/users/user-5.jpg" alt="user-image"
                                                    class="avatar-xs rounded-circle me-2" /> Lasse C.
                                                Overgaard
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/images/users/user-6.jpg" alt="user-image"
                                                    class="avatar-xs rounded-circle me-2" /> Kasper S.
                                                Jessen
                                            </td>
                                            <td><i class="mdi mdi-checkbox-blank-circle text-success"></i>
                                                Confirm</td>
                                ...
                                <table
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <img src="assets/images/users/user-1.jpg" alt="user-image"
                                                    class="avatar-xs me-2 rounded-circle" /> Riverston
                                                Glass
                                                Chair
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="assets/images/users/user-4.jpg" alt="user-image"
                                                    class="avatar-xs me-2 rounded-circle" /> Oasis Bathroom
                                                Teak Corner
                                            </td>
                                            <td><span class="badge rounded-pill bg-warning">Shipped</span>
                                            </td>
                                            <td>
                                                $8451
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="assets/images/users/user-5.jpg" alt="user-image"
                                                    class="avatar-xs me-2 rounded-circle" /> BeoPlay
                                                Speaker
                                            </td>
                                            <td><span class="badge rounded-pill bg-success">Delivered</span>
                                            </td>
