                                    ...
                                    <form id="ventaForm">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="cliente_nombre"
                                                    name="cliente_nombre" placeholder="Seleccionar Cliente" readonly>
                                                <input type="hidden" id="cliente_id" name="cliente_id">
                                                <button type="button" class="btn btn-outline-primary"
                                                    data-bs-toggle="modal" data-bs-target="#clienteModal">Seleccionar
                                                    Cliente</button>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="usuario_nombre"
                                                name="usuario_nombre"
                                                value="{{ Auth::user()->nombre }} ({{ Auth::user()->email }})" readonly>
                                        </div>
                                        <div class="mb-3">
                                            <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal"
                                                data-bs-target="#productoModal">Seleccionar Productos</button>
                                        </div>
